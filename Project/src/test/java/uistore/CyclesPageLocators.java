...
import org.openqa.selenium.By;
        ...
        /*
     * Class Name: CyclesPageLocators
     * Author Name: Chikka Anjani
     * Description: This class contains locators for elements on CyclesPageLocators
     */
...
public class CyclesPageLocators {
    ...
    public static By firstreview = By.id("radio4");
    public static By size = By.xpath("//p[text()='Size']");
    public static By firstsize = By.id("radio8");
