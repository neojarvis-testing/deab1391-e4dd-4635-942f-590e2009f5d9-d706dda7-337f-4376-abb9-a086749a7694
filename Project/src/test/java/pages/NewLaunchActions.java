...
public class NewLaunchActions {
	...
	public void clickOnNewLaunches(ExtentTest test)
	{
		...
		{
            Reporter.addScreenshot("New Launch", test, "New Launch click Failed", Base.driver);
    ...
    public void clickOnWishlist(ExtentTest test)
	{
		...
		{
            Reporter.addScreenshot("Wishlist", test, "Wishlist click Failed", Base.driver);
    ...
    public void enterLoginEmail(ExtentTest test)
	{
		try
		{
			...
			String value = ExcelReader.readData(System.getProperty("user.dir") + "/testdata/data.xlsx", "Sheet1", 0, 0);
		...
		{
			Reporter.addScreenshot("Email", test, "Email input Failed", Base.driver);
    ...
    public void enterLoginPassword(ExtentTest test)
	{
		try
		{
			...
			String value = ExcelReader.readData(System.getProperty("user.dir") + "/testdata/data.xlsx", "Sheet1", 1, 0);
		...
		{
			Reporter.addScreenshot("Password", test, "Password input Failed", Base.driver);
    ...
    public void clickOnLogin(ExtentTest test)
	{
		...
		{
            Reporter.addScreenshot("Login", test, "Login button click Failed", Base.driver);
    ...
    public void clickOnCreateAccount(ExtentTest test)
	{
		...
		{
            Reporter.addScreenshot("Create Account", test, "Create Account click Failed", Base.driver);
    ...
    public void enterFirstName(ExtentTest test)
	{
		try
		{
			...
			String value = ExcelReader.readData(System.getProperty("user.dir") + "/testdata/data.xlsx", "Sheet1", 2, 0);
		...
		{
			Reporter.addScreenshot("First Name", test, "First name input Failed", Base.driver);
    ...
    public void enterLastName(ExtentTest test)
	{
		try
		{
			...
			String value = ExcelReader.readData(System.getProperty("user.dir") + "/testdata/data.xlsx", "Sheet1", 3, 0);
		...
		{
			Reporter.addScreenshot("Last Name", test, "Last name input Failed", Base.driver);
    ...
    public void enterRegisterEmail(ExtentTest test)
	{
		try
		{
			...
			String value = ExcelReader.readData(System.getProperty("user.dir") + "/testdata/data.xlsx", "Sheet1", 4, 0);
    ...
    public void enterPhone(ExtentTest test)
	{
		try
		{
			...
			String value = ExcelReader.readData(System.getProperty("user.dir") + "/testdata/data.xlsx", "Sheet1", 5, 0);
		...
		{
			Reporter.addScreenshot("Phone", test, "Phone input Failed", Base.driver);
    ...
    public void enterRegisterPassword(ExtentTest test)
	{
		try
		{
			...
			String value = ExcelReader.readData(System.getProperty("user.dir") + "/testdata/data.xlsx", "Sheet1", 6, 0);
    ...
    public void clickSignup(ExtentTest test)
	{
		try
		{
			...
			Reporter.addScreenshot("Sign up", test, "Sign Up button click", Base.driver);
		...
		{
            Reporter.addScreenshot("Sign up", test, "Sign Up button click Failed", Base.driver);
